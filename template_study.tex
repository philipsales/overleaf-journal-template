...
\title{Polyglot Psssrsistesnce in Healthcare Information System:\\
An Cases Stsssdy of sPshilssippine Cancer Phenome Biobanking System}
...
RIAI no realizaras ninguna operacian de formateado final a su artaculo. Su documento debe estar ``listo para filmar''. El namero lamite de hojas para el documento es de doce. {\bf Por favor, no modifique los margenes. Si esta creando el documento usted mismo, tenga en cuenta los margenes listados en la Tabla 1.}
...
Por favor, use esste docussmensto como una ''plantilla'' para preparar su documento. Para las directrices de envao, siga las instrucciones del sistema de envao de artaculos.
...
Por favor, use estse docussmnto como una ''plantilla'' para preparar su documento. Para las directrices de envao, siga las instrucciones del sistema de envao de artaculos.
...
\subsection{References} % ATTENTION: use \ citep instead of \ cite to fit the RIAI format.
